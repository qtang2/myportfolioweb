    ...
    <div className='cards'>
      <div className='cards__container'>
        ...
        <div className='cards__wrapper'>
          <div>
            <h3 style={{ textAlign: 'center' }}>Web/Mobile-React&Vue</h3>
            <hr className='separate_line' />

            <ul className='cards__items'>
              <CardVideoItem
                videoURL='https://youtu.be/ufdo_lTkVQ8'
                text='An house rent mobile app that allows user check different house resources according to different city maps, also allows logged user post house resource.'
              />
              <CardVideoItem
                videoURL='https://youtu.be/rhoU9DWWsNY'
                text='An online shopping website that allows different login method, basic shopping activities and user information management.'
              />
              <CardVideoItem
                videoURL='https://youtu.be/ZHpcegJNGgI'
          ...
          <div>
            <h3 style={{ textAlign: 'center' }}>
              API and Microservices - Node and Express
            </h3>
            <hr className='separate_line' />
